...
//        } // null pointer, for đến count thôi.
    ...
    public static void playWithTriangle() {
        ...
        // Cha new Cha (cụ thể - concrete class).
        ...
        // Đọc ngược chiều: TGV là 1 TG.
        rt2.paint(); // Chấm ra hàm Cha nhưng chạy hàm Con.
                     // Nếu Con trùng tên hàm Cha, Cha ngồi im để Con lo, @Override qua mặt Cha.
        // Khai báo gì thì hành xử như thế, vì mình đặt tên cho object kèm data type,
        // Object sẽ thuộc nhóm gì/Khuôn nào, theo Khuôn nhìn hành xử, nhìn hàm.
