...
public abstract class Pet {
    ...
    // Hành động chạy của mỗi Con: hoàn toàn khác nhau, khác nhau về tốc độ, dáng chạy -> ngầm hiểu là xử lí khác nhau!
    // Việc chạy() là 1 ý tưởng chung chung mà loài Pet cần có,
    // chạy() là 1 thứ đi kèm Pet, cụ thể thế nào là tùy từng đứa.
    // ABSTRACT METHOD: CÁI GÌ MÀ KHÔNG CỤ THỂ KHI ĐỀ CẬP VỀ NÓ -> SURE CHUNG CHUNG LÀ ABSTRACT.
